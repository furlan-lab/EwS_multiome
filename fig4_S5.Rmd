...
#tumor only patient samples UMAP, Fig 4A
```{r}
...
```{r}
kmean_probes[[1]] %in% rownames(obj) %>% table()
```
...
counts of fusion reulgated module low v high
```{r}
obj@meta.data %>% names()
```
...
#spatial module expression Fig S5E
```{r}
