...
#get rid of cell cycle genes?
# 
# s.genes <- cc.genes$s.genes
# g2m.genes <- cc.genes$g2m.genes
# 
# 
# kmean<-kmean[!kmean$gene %in% c(s.genes, g2m.genes),]


ggplot(kmean, aes(x = Correlation, color = factor(kmean)))+geom_density()

kmean<-kmean[kmean$Correlation > 0.75,]
